...
desc 'Generate documentation for the mollie_ideal extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MollieIdealExtension'
...
desc 'Test the mollie_ideal extension.'
...
namespace :test do
  desc 'Functional test the mollie_ideal extension.'
  ...
  desc 'Unit test the mollie_ideal extension.'
